...
export default class InstrumentBoard extends Component {
  ...
  static defaultProps = {
    ...
    degreeTextColor: '#999',
    contentTexts: ['精打细算', '理想消费', '不差钱', '有的是钱'],
  ...
  render() {
    ...
    return (
      <View>
        ...
        <AnimatedBoardTitle
          title={this.props.title? this.props.title : titleValue}
          startAngle={startAngle}
          radius={radius}
          innerRadius={this.props.progressRadius}
          subTitle={this.props.subtitle ? this.props.subtitle : contentTexts[this.getContentTextIndex()]}
        />
      </View>
    );
  }
