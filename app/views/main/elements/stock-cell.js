...
export default class StockCell extends React.Component {
  ...
  render() {
    console.log(this.state.selectedStock[0], this.props.stock[0], this.state.selectedStock[0] === this.props.stock[0]);
    return (
      <TouchableHighlight
        style={[this.state.selectedStock[0] === this.props.stock[0] ? styles.selected : null]}
        onPress={() => this.changeSelectedStock(this.props.stock)} underlayColor="#202020"
      >
        <View style={[styles.container, this.state.selectedStock[0] === this.props.stock[0] ? styles.selected : null]}>
          ...
          <View style={styles.price}>
            <Text style={styles.priceText}>
              {this.props.watchlistResult && this.props.watchlistResult[this.props.stock[0]] && this.props.watchlistResult[this.props.stock[0]].LastTradePriceOnly}
            </Text>
          </View>
          <TouchableHighlight
            style={(() => {
              switch (this.props.watchlistResult
                      && this.props.watchlistResult[this.props.stock[0]]
                      && this.props.watchlistResult[this.props.stock[0]].Change
                      && this.props.watchlistResult[this.props.stock[0]].Change.startsWith('+')) {
                ...
                {(() => {
                  switch (this.state.selectedProperty) {
                    ...
                    case 'ChangeinPercent': return (
                      this.props.watchlistResult
                      && this.props.watchlistResult[this.props.stock[0]]
                      && this.props.watchlistResult[this.props.stock[0]].ChangeinPercent) || '--';
                    case 'MarketCapitalization': return (
                      this.props.watchlistResult
                      && this.props.watchlistResult[this.props.stock[0]]
                      && this.props.watchlistResult[this.props.stock[0]].MarketCapitalization) || '--';
                    default: return (
                      this.props.watchlistResult
                      && this.props.watchlistResult[this.props.stock[0]]
                      && this.props.watchlistResult[this.props.stock[0]].Change) || '--';
